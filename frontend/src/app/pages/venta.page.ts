import { Component } from '@angular/core';
      ...
      template: `
        <mat-card class="page-card">
          ...
          <form [formGroup]="form" (ngSubmit)="save()" class="form-grid">
            <mat-form-field appearance=\"outline\"><mat-label>clienteId</mat-label><input matInput type=\"number\" formControlName=\"clienteId\" /></mat-form-field>
  ...
  <td mat-cell *matCellDef="let row">
    ...
    export class VentaPage {
      items: any[] = [];
      displayedColumns = ['id', 'clienteId', 'fecha', 'total', 'estado', 'acciones'];
      ...
      constructor(private fb: FormBuilder, private service: VentaService) {
        this.load();
      }
